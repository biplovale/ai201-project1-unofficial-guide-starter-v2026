...
These documents are short threads containing a title and usually 3-5 replies. A 600-charactor chunk should keep most complete advice threads together, preserving the context between different replies, as from index command results, there 23 documents, ~543 characters per document.

The 120-character overlap provides enough continuity for the few longer threads that needs to be split without creating excessive duplicate content.
